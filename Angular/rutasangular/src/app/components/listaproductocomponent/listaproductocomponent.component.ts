...
@Component({
  selector: 'app-listaproductocomponent',
  templateUrl: './listaproductocomponent.component.html',
  styleUrls: ['./listaproductocomponent.component.css']
})
export class ListaproductocomponentComponent implements OnInit {
